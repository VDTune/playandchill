...
<head>
    ...
    <!-- modernizr js -->
    <link rel="stylesheet" href="/public/front-end/css/main.css">
...
<body>
    ...
    <?php
    require_once("E:/xampp/htdocs/playandchill.net/public/front-end/header.php")
    ?> 
    <!-- footer section end -->
    <!-- all js here -->
